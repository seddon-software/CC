...
code.set_message_area(row=20, col=58)
...
code(0, "but printf doesn't try to remove the 3 parameters it thinks are on the stack")
code(0, "main will pop the 1 parameter it pushed")
p1.hide_and_wait()
code(15, "the program never crahes despite the errors")
